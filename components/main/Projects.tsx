...
import ProjectCarousel from "../sub/ProjectCarousel";
import Caruseli from "../sub/Caruseli";

const Projects = () => {
  return (
    <div
      className="flex flex-col items-center justify-center py-20  no-scrollbar  z-[25]"
      id="projects"
    >
